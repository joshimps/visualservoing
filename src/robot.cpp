...
void Robot::calculateJacobianInEndEffectorFrame()
{
    ...
    Eigen::MatrixXd jacobianInWorldFrame;
    Eigen::Vector3d unitVector;
    Eigen::Matrix3d rotationMatrixItoB;
    Eigen::Vector3d translationMatrixItoB;
    Eigen::Vector3d translationMatrixNtoB;
    ...
    jacobianInWorldFrame.resize(6, d_.size());
    ...
    for (int i = 0; i < jointTransforms_.size(); i++)
    {
        ...
        // Row 1
        jacobianInWorldFrame(0, i) = jacobianLinearVelocityComponent(0, 0);
        // Row 2
        jacobianInWorldFrame(1, i) = jacobianLinearVelocityComponent(1, 0);
        // Row 3
        jacobianInWorldFrame(2, i) = jacobianLinearVelocityComponent(2, 0);
        // Row 4
        jacobianInWorldFrame(3, i) = jacobianRotationalVelocityComponent(0, 0);
        // Row 5
        jacobianInWorldFrame(4, i) = jacobianRotationalVelocityComponent(1, 0);
        // Row 6
        jacobianInWorldFrame(5, i) = jacobianRotationalVelocityComponent(2, 0);
    }
    ...
    jacobianInEndEffectorFrame_ = alterationMatrix * jacobianInWorldFrame;
